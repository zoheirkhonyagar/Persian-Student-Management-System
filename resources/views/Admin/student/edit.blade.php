    ...
    <div class="row placeholders col-md-4" style="text-align: right">
        <form class="form-horizontal" method="POST" action="{{ route('students.update' , [ 'id' => $student->id]) }}" enctype="multipart/form-data">
            ...
            <div class="form-group{{ $errors->has('class_name') ? ' has-error' : '' }}">
                ...
                <div class="col-md-7">
                    <input id="class_name" type="text" class="form-control" name="class_name" value="{{ $student->class_name }}" autofocus>
            ...
            <div class="form-group{{ $errors->has('father_phone') ? ' has-error' : '' }}">
                ...
                <div class="col-md-7">
                    <input id="father_phone" type="text" class="form-control" name="father_phone" value="{{ $student->father_phone }}" autofocus>
            ...
            <div class="form-group{{ $errors->has('mother_phone') ? ' has-error' : '' }}">
                ...
                <div class="col-md-7">
                    <input id="mother_phone" type="text" class="form-control" name="mother_phone" value="{{ $student->mother_phone }}" autofocus>
